...
const GUIDES = [
  ...
  {
    href: '/guides/what-is-ucits',
    flag: '🇪🇺',
    country: 'Europe-wide',
    title: 'What is a UCITS ETF?',
    subtitle: 'The regulatory framework behind every ETF available to European investors — and why you cannot buy Vanguard funds from the US',
    tags: ['UCITS', 'ETF Basics', 'Regulation'],
    readTime: '5 min',
  },
  {
    href: '/guides/etf-accumulating-vs-distributing',
    flag: '🇪🇺',
    country: 'Europe-wide',
    title: 'Accumulating vs Distributing ETFs',
    subtitle: 'Same index, two structures. Which is better depends on where you live and how your country taxes investment income',
    tags: ['ETF Structure', 'Dividends', 'Tax'],
    readTime: '5 min',
  },
  {
    href: '/guides/ecb-interest-rates-explained',
    flag: '🏦',
    country: 'Eurozone',
    title: 'ECB Interest Rates Explained',
    subtitle: 'How ECB rate decisions flow through to stock valuations, bank margins, bond yields, and the euro — with sector-by-sector impact',
    tags: ['ECB', 'Monetary Policy', 'Macro'],
    readTime: '6 min',
  },
  {
    href: '/guides/european-indices-explained',
    flag: '📊',
    country: 'Europe-wide',
    title: 'AEX, DAX, CAC 40, FTSE 100 Explained',
    subtitle: 'Six major European indices, six different market characters — what each measures, the dominant sectors, and what moves them',
    tags: ['Indices', 'AEX', 'DAX', 'CAC 40'],
    readTime: '6 min',
  },
  {
    href: '/guides/bond-yields-and-stocks',
    flag: '📉',
    country: 'Eurozone',
    title: 'Bond Yields and European Stocks',
    subtitle: 'Why rising Bund yields compress growth stock valuations, how the BTP-Bund spread signals eurozone stress, and which sectors benefit',
    tags: ['Bonds', 'Yields', 'Macro', 'BTP-Bund'],
    readTime: '5 min',
  },
]
